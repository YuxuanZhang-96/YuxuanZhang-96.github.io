...
8. __Yuxuan Zhang*__, Yuchen Lu, Luciano Sebastian Martinez-Rau, Quan Qiu*, Sebastian Bader. (2025). "Energy-Efficient Real-Time Weed Classification on MCUs using a Channel Attention CNN for Precision".  _Measurement_ (under review). __(IF 5.6, JCR Q1, 中科院2区)__
